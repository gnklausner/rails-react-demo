@Contact = React.createClass
  ...
  formatPhoneNumber: (phone_number)->
    ...
    phone_number_with_extension[0] = "#{displayed_country_code}(#{area_code})" +
                                     " #{prefix}-#{line_number}"
    return phone_number_with_extension.join(' ext.')
  ...
  render: ->
    React.DOM.tr null,
      ...
      React.DOM.td null, @formatPhoneNumber(@props.contact.phone_number)
